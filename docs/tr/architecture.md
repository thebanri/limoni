...
## 5. Unicode Doğu Asya genişliği ve donanım imleci eşitlemesi
...
## 6. Motor güvenliği ve belirlenimci komut dağıtımı
...
## 7. Birleşik kök facade (`github.com/thebanri/limoni`)
