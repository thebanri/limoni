...
| `apps/scoreboard` | Lemon Hunt's shared leaderboard server, on Render's free plan with a free Neon Postgres (or a disk, on Railway) — its own module, so pgx reaches no importer |
